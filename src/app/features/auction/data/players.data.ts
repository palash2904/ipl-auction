...
const setDefinitions = [
  ...
  ['CAPPED BATTERS B', ['Ruturaj Gaikwad', 'Quinton de Kock', 'Rishabh Pant', 'Kane Williamson', 'Sanju Samson', 'Paul Stirling', 'Tilak Varma', 'Alex Hales', 'Devdutt Padikkal', 'Rajat Patidar', 'Shikhar Dhawan', 'Suresh Raina']],
  ...
  ['CAPPED ALL-ROUNDERS B', ['Moeen Ali', 'Shivam Dube', 'Sam Curran', 'Krunal Pandya', 'Marcus Stoinis', 'Vijay Shankar', 'Mitchell Marsh', 'Liam Livingstone', 'Shimron Hetmyer', 'Jamie Overton']],
